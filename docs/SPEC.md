...
- **PR2.8**: `017_rls_hardening.sql` — items F1/F2/F3 from `RLS_AUDIT.md` §H, plus service-role INSERT policies on `users` and `profiles`. Subject to `migration-approved` label gate.
