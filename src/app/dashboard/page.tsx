            ...
            <form onSubmit={handleAuth}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:border-[#0f1f3d] focus:ring-1 focus:ring-[#0f1f3d] outline-none text-slate-900"
                  required
                  autoComplete="email"
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-4 pr-11 py-2.5 text-sm border border-gray-300 rounded-lg focus:border-[#0f1f3d] focus:ring-1 focus:ring-[#0f1f3d] outline-none text-slate-900"
                    required
                    minLength={8}
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 flex items-center justify-center w-11 text-gray-400 hover:text-[#0f1f3d] transition-colors"
                  >
                    {showPassword ? (
                      <svg
                        className="w-5 h-5"
